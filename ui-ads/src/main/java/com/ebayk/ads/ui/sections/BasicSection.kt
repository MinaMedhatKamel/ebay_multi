...
@Composable
fun BasicSection(basicInfo: BasicInfoSection) {
    ...
    Column(Modifier.padding(8.dp)) {
        ...
        Text(
            ...
            style = bodyMediumGray14, modifier = Modifier.padding(bottom = 16.dp, top = 8.dp)
        )
        //footer
...
fun BasicInfoPreview() {
    BasicSection(BasicInfoSection("test", "sadasd", "asdasd", "12323213", "10", "12314213213"))
}
